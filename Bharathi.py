#_____________________________________________________Bharathi________________________________________________________
...
class Bharathi():
    ...
    def take_Command(self):
        try:
            ...
            with sr.Microphone() as source:
                ...
                if 'Bharathi' in command1: 
                    command1 = command1.replace('Bharathi','')
                
            return command1
        except:
            return 'None'
        
    #Bharathi commands controller 
    def run_Bharathi(self):
        self.wish()
        self.talk('Hello boss I am Bharathi your assistant. pleell me how can i help youase t')
        while True:
            ...
            #Interaction commands with Bharathi
            ...
            #command if you don't want the Bharathi to spack until for a certain time
            #Note: I can be silent for max of 10mins
            # Eg: Bharathi keep quiet for 5 minutes 
            ...
            #Eg : Bharathi open facebook (or) Bharathi open social media facebook 
            ...
            #Eg: Bharathi open command prompt
            ...
            #Eg: Bharathi check covid (or) corona status
            ...
            #Eg: Bharathi start Screen recording
            ...
            #Eg: Bharathi check my ip address
            ...
            #group => Eg: send a message to school group NOTE: mention the name "group" otherwise Bharathi cannot detect the name
            elif ('send a message' in self.command):
                self.whatsapp(self.command)
            #command for sending an email 
            #Eg: Bharathi send email
            elif 'send email' in self.command:
                self.verifyMail()
            #command for checking the temperature in surroundings
            #Bharathi check the surroundings temperature
            ...
            #Eg: Bharathi check my internet speed
            elif "internet speed" in self.command:
                self.InternetSpeed()
            #command to make the Bharathi sleep
            #Eg: Bharathi you can sleep now
                ...
                break
            #command for waking the Bharathi from sleep
            #Bharathi wake up
            ...
            #command for exiting Bharathi from the program
            #Eg: Bharathi goodbye
            ...
            #Eg: Bharathi what is the system condition
            ...
            #Eg: Bharathi shutdown the system
            ...
            #Eg: Bharathi restart the system
    ...
    #Fun commands to interact with Bharathi
    def Fun(self,command):
        print(command)
        if 'your name' in command:
            self.talk("My name is Bharathi")
    ...
    def B_S(self,command):
        print(command)
        try:
            # ('what is meant by' in self.command) or ('tell me about' in self.command) or ('who is' in self.command)
